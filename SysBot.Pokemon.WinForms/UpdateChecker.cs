...
namespace SysBot.Pokemon.WinForms
{
    public class UpdateChecker
    {
        ...
        private const string RepositoryName = "NotSandwichBot";
        ...
        public static async Task<(bool UpdateAvailable, bool UpdateRequired, string NewVersion)> CheckForUpdatesAsync()
        {
            ...
            bool updateAvailable = latestRelease != null && latestRelease.TagName != NotSandwichBot.Version;
        ...
        private static async Task<ReleaseInfo?> FetchLatestReleaseAsync()
        {
            ...
            try
            {
                ...
                client.DefaultRequestHeaders.Add("User-Agent", "NotSandwichBot");

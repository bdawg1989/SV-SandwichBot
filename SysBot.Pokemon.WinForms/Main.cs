...
namespace SysBot.Pokemon.WinForms
{
    public sealed partial class Main : Form
    {
        ...
        private async Task InitializeAsync()
        {
            ...
            LoadControls();
            Text = $"{(string.IsNullOrEmpty(Config.Hub.BotName) ? "NotPaldea.net" : Config.Hub.BotName)} {NotSandwichBot.Version} ({Config.Mode})";
            Task.Run(BotMonitor);
        ...
        private void LoadControls()
        {
            ...
            CB_Routine.SelectedValue = (int)PokeRoutineType.RotatingSandwichBot; // default option

...
namespace SysBot.Pokemon
{
    public class DiscordSettings
    {
        ...
        public string BotGameStatus { get; set; } = "Hosting S/V Sandwichs";
        ...
        // Whitelists
        [Category(Roles), Description("Users with this role are allowed to enter the Sandwich queue.")]
        public RemoteControlAccessList RoleSandwichRequest { get; set; } = new() { AllowIfEmpty = false };
        ...
        [Category(Channels), Description("Sandwich Embed Channels.")]

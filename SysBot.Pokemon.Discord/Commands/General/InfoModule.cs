...
namespace SysBot.Pokemon.Discord
{
    ...
    {
        private const string detail = "I am an Open Source SandwichBot powered by PKHeX.Core and other open-source software.";
        public const string version = NotSandwichBot.Version;
        private const string support = NotSandwichBot.Repo;

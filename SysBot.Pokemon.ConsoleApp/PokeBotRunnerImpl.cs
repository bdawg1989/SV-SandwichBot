...
namespace SysBot.Pokemon.ConsoleApp
{
    ...
    {
        public PokeBotRunnerImpl(PokeSandwichHub<T> hub, BotFactory<T> fac) : base(hub, fac)
        {
        }

        public PokeBotRunnerImpl(PokeSandwichHubConfig config, BotFactory<T> fac) : base(config, fac)
        {
        }
